...
async function completeStaffSeeding() {
  console.log('🌱 COMPLETING STAFF SEEDING\n');
  ...
  try {
    ...
    for (const staffData of realStaffData) {
      ...
      if (!user) {
        ...
        console.log(`  ℹ️  User exists: ${staffData.email}`);
      }
    ...
    console.log(`Skipped: ${skippedCount} existing staff members`);

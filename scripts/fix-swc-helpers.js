...
/**
 * Fix for @swc/helpers Module Resolution Error
 * 
 * This script addresses the "Can't resolve '@swc/helpers'" error
 * by ensuring all Next.js related dependencies are properly installed.
 */
...
console.log('🔧 Fixing @swc/helpers Module Resolution Error');
console.log('==========================================');
...
try {
  ...
  // Step 5: Install @swc/helpers specifically
  console.log('5. Installing @swc/helpers...');
  execSync('npm install @swc/helpers --save-dev', { stdio: 'inherit' });
  console.log('   ✓ @swc/helpers installed');
  
  // Step 6: Verify installation
  console.log('6. Verifying installations...');
  try {
  ...
  console.log('\n✅ @swc/helpers module resolution fix completed!');
  console.log('\nNext steps:');
  ...
  console.error('\n❌ Error during @swc/helpers module resolution fix:', error.message);
  process.exit(1);
}